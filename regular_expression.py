...
print("provide me the list of emails that do have special characters of #~`! ")
for test in my_list:
...
print("provide me the list of emails that start with numbers")
for test in my_list:
...
print("provide me the list of emails that start with numbers followed by an underscore")
...
print("provide me the list of emails that start with numbers followed by an underscore or small case characters")
...
print("provide me the list of emails that start with numbers followed by an underscore or small case characters or large case characters")
for test in my_list:
...
print("Provide me list of emails with only numbers before the @ ")
for test in my_list:
...
print("Provide me list of emails with numbers anywhere before the @ ")
