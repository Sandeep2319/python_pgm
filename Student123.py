...
def main():
    ...
    duplicate_gaurav= Student("Gaurav",1,100,'Python')
    ...
    # # set the PROTECTED variable outside the class 
    ...
    # #gaurav.change_schoolname("Sunbeam") # this will change the class variable 
